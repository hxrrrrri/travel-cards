...
final routerProvider = Provider<GoRouter>((ref) {
  ...
  return GoRouter(
    ...
    routes: [
      ...
      GoRoute(
          path: '/travel-cards/create',
          builder: (_, __) => const CreateTravelCardScreen()),
      GoRoute(
        path: '/travel-cards/:id',
        builder: (_, state) =>
            TravelCardSummaryScreen(cardId: state.pathParameters['id']!),
      ),
      GoRoute(
        path: '/travel-cards/:id/setup',
        builder: (_, state) =>
            DiscoverySetupScreen(cardId: state.pathParameters['id']!),
      ),
      GoRoute(
        path: '/travel-cards/:id/map',
        builder: (_, state) =>
            DiscoveryMapScreen(cardId: state.pathParameters['id']!),
      ),
      // Live navigation screen
      GoRoute(
        path: '/navigate/:cardId/:placeId',
